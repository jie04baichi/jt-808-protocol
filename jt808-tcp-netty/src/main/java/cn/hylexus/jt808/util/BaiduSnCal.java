...
public class BaiduSnCal {
        public static String work(String url_prax,Map paramsMap) throws UnsupportedEncodingException,
                ...
                paramsMap.put("ak", "aElWRH5ayr3b6fGBlyjZH0z9o857Y8aI");
                */
                
                //http://api.map.baidu.com/geocoder/v2/?location=40.057058,116.307880&output=json&ak=aElWRH5ayr3b6fGBlyjZH0z9o857Y8aI&sn=14ca832e3e5b07a1c5bd66fa5b1cf545       
                ...
                String wholeStr = new String(url_prax + paramsStr + "9stABdl7H4wvPnbtO9RCdFC7h1DqjFex");
                // 对上面wholeStr再作utf8编码
